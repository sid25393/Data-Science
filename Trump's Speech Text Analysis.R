...
library(readr)
url <- ("https://drive.google.com/file/d/1QOkGFrSgWmJKee1217NsdGGvQA5gY1d6/view?usp=sharing")
precorpus<- read.csv2(url)
...
newscorpus<- corpus(precorpus$`Full Text`,
                    docnames=precorpus$Document,
                    docvar=data.frame(Year_tbd=precorpus$`Date of Publication`,
...
swlist = c("s", "u","said", "the", "also", "say", "just", "like","for", 
           ...
           "market", "share", "one", "company", "going", "seek", "put", "many",
           "must", "new", "thank", "respect", "together", "today", "years", "m")
